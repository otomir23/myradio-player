...
export default function VolumeSlider() {
    ...
    return (
        <div className="flex items-center gap-2 group shrink-0 max-sm:hidden relative">
            <img src={volumeIcon} className="size-4" alt="Volume icon" />
            <div
                ...
                before:absolute before:-top-2 before:-bottom-8 before:-inset-x-4"
                draggable={false}
            >
                <input
                    type="range"
